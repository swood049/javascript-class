//Author: Steven Woodard Learned From Lynda course
//Date: 23-Sept-2019
   ...
   function cardDrag(e){
    ...
    var DiscardPile = function(){
        ...
        this.init = function(){
            ...
            holderContainer.classList.add("holder_container");
            holderLabel.classList.add("holder_label");
            holderTarget.classList.add("holder_target");
